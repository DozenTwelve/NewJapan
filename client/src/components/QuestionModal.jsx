      ...
      <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl border border-gray-200">
        ...
        {!answerSelected ? (
          <div className="flex justify-center gap-4">
            <ModernButton variant="green" onClick={() => onAnswer("〇")}>〇</ModernButton>
            <ModernButton variant="red" onClick={() => onAnswer("×")}>×</ModernButton>
          </div>
        ) : (
          <div className="text-center">
            ...
            <div className="mt-4 flex justify-center gap-3">
              <ModernButton variant="green" onClick={onNext}>次のニュースへ</ModernButton>
              <ModernButton variant="gray" onClick={onShowOriginal}>原文を見る</ModernButton>
            </div>
          </div>
        )}

        <div className="mt-6 text-center">
          <ModernButton variant="gray" onClick={onClose}>閉じる</ModernButton>
        </div>
      </div>
    </div>
  );
